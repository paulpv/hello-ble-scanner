...
public class SortedList<T> {
    private static final String TAG = "SortedList";
     ...
     *
     * @param items Array of items to be added into the list.
     * @see com.pebblebee.bletool.testapp.adapter.SortedList#addAll(T[] items, boolean mayModifyInput)
     */
    ...
    */
    ...
    public abstract static class SortedListAdapterCallback<T2> extends Callback<T2> {
        ...
        private static final String TAG = "SortedListAdapterCallback";
